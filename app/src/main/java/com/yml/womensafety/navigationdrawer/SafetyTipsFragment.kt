...
class SafetyTipsFragment : Fragment(R.layout.fragment_safety_tips) {
    ...
    private fun displaySafetyTips() {
        tipsTextList.apply {
            add(SafetyTips("If walking by yourself, get off your cell phone. Chatting can distract you, " +
                "it's better to be aware of your surroundings."))
            add(SafetyTips("If walking by yourself, hold your cell phone and be ready to make an emergency call."))
            add(SafetyTips("Look underneath your car before approaching it in a parking garage or lot at night."))
            add(SafetyTips("If you return to your car and see that a van is parked right next to the driver's side, " +
                    "enter through the passenger side. Predators often use vans and will disguise it as a family car."))
            add(SafetyTips("You return to your car and it has a flat tire. Back away. " +
            ...
            add(SafetyTips("When the pharmacist asks you to confirm your home address, whisper it to them." +
                    " Broadcasting your home address among strangers on the line could compromise your safety."))
            add(SafetyTips("If you're checking in to a hotel room. " +
            ...
            add(SafetyTips("When traveling, do not walk with your map in your hand. " +
                    "It is a dead giveaway that you are a tourist. Therefore, you are an easy target."))
            add(SafetyTips("If you call for room service, and you get a knock on your door, " +
            ...
            add(SafetyTips("When asking for directions and someone offers to show you the way by having you follow them, do not go. Just ask for them to point you in the right direction." +
                    " Often, predators just want to get you to a place less crowded where your screams can't be heard."))
            add(SafetyTips("If someone tries to grab you, twist your arm up and down and yell, " +
                    "\"Stop!\" Do anything you can to draw attention to yourself."))
            add(SafetyTips("Always pour your own drink at a party and bring it with you everywhere...even to the bathroom. " +
                    "This will make it a lot harder for someone to drug you via you drink."))
            add(SafetyTips("If someone is chasing after you, run away in a zig zag pattern." +
                    " This will exhaust your attacker."))
            add(SafetyTips("Don't check-in on Facebook when you arrive somewhere. " +
