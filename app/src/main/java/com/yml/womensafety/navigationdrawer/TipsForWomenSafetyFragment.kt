...
class TipsForWomenSafetyFragment : Fragment(R.layout.fragment_tips_for_women_safety) {
    ...
    private fun displaySafetyTips() {
        tipsTextList.add(
            SafetyTips(
                "If walking by yourself, get off your cell phone. Chatting can distract you, " +
        ...
        tipsTextList.add(
            SafetyTips(
                "If you return to your car and see that a van is parked right next to the driver's side, " +
                        "enter through the passenger side. Predators often use vans and will disguise it as a family car."
            )
        )
        tipsTextList.add(
            SafetyTips(
                "You return to your car and it has a flat tire. Back away. " +
        ...
        tipsTextList.add(
            SafetyTips(
                "If you're checking in to a hotel room. " +
        ...
        tipsTextList.add(
            SafetyTips(
                "When traveling, do not walk with your map in your hand. " +
                        "It is a dead giveaway that you are a tourist. Therefore, you are an easy target."
            )
        )
        tipsTextList.add(
            SafetyTips(
                "If you call for room service, and you get a knock on your door, " +
        ...
        tipsTextList.add(
            SafetyTips(
                "If someone tries to grab you, twist your arm up and down and yell, " +
                        "\"Stop!\" Do anything you can to draw attention to yourself."
            )
        )
        tipsTextList.add(
            SafetyTips(
                "Always pour your own drink at a party and bring it with you everywhere...even to the bathroom. " +
                        "This will make it a lot harder for someone to drug you via you drink."
            )
        )
        tipsTextList.add(
            SafetyTips(
                "If someone is chasing after you, run away in a zig zag pattern." +
                        " This will exhaust your attacker."
            )
        )
        tipsTextList.add(
            SafetyTips(
                "Don't check-in on Facebook when you arrive somewhere. " +
